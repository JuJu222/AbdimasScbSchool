    ...
    <div class="container mt-3">
        <form action="{{ route('perawatan.update', $currativeMaintenance->currative_maintenance_id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="date" name="date_real" class="form-control" value="{{ $currativeMaintenance->date_real }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="keterangan" class="form-control">{{ $currativeMaintenance->keterangan }}</textarea>
            </div>
            <div class="form-group">
